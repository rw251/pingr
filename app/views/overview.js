...
var overview = {
  ...
  create: function(loadContentFn) {
    ...
    setTimeout(function() {
      ...
      base.updateFixedHeightElements([{selector:'#personalPlanTeam',padding:820, minHeight:200},{selector:'#advice-list',padding:430, minHeight:250},{selector:'.table-scroll',padding:190, minHeight:300}]);
    }, 0);
